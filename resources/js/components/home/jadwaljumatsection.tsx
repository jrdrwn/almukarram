                        ...
                        <div className="relative z-10 flex flex-col gap-12 lg:flex-row lg:items-center lg:justify-between">
                            ...
                            <div className="max-w-xl">
                                ...
                                <p className="text-lg leading-relaxed text-emerald-100/70">
                                    Mari bersama memakmurkan Sholat Jumat
                                    berjamaah di Masjid Agung Al-Mukarram.
                                    Jangan lupa datang lebih awal untuk meraih
                                    fadhilah shaf pertama dan mendengarkan
                                    khutbah dengan saksama.
                                </p>
