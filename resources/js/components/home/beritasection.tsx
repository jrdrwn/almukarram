                    ...
                    >
                        ...
                        <div className="absolute bottom-0 left-0 w-full max-w-4xl p-8 pb-32 sm:p-12 sm:pb-40 lg:p-16 lg:pb-48">
                            ...
                            <p className="mb-6 line-clamp-2 max-w-2xl text-base text-white/70 sm:text-lg lg:mb-8">
                                ...
                                Masjid Agung Al-Mukarram Amanah menggelar
                                kegiatan buka bersama yang dihadiri ratusan
                                jamaah dari berbagai pelosok daerah.
                            </p>
                    ...
                    <div className="relative z-20 mx-auto -mt-16 grid max-w-6xl grid-cols-1 gap-6 px-4 sm:-mt-24 md:grid-cols-2 lg:-mt-32 lg:grid-cols-3">
                        {[
                            ...
                            <a
                                key={idx}
                                href="#"
                                className="group relative flex min-h-55 flex-col justify-between overflow-hidden rounded-[2.5rem] border border-zinc-100 bg-zinc-50 p-6 transition-all duration-500 hover:-translate-y-2 hover:shadow-xl dark:border-zinc-800/50 dark:bg-zinc-900 lg:p-8"
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="mb-5 flex items-center justify-between">
                                        ...
                                        <div className="flex h-8 w-8 items-center justify-center rounded-full border border-border/50 bg-white/50 text-muted-foreground backdrop-blur-sm transition-transform group-hover:-rotate-45 group-hover:bg-primary group-hover:text-primary-foreground group-hover:border-primary dark:bg-zinc-950/50">
