                ...
                {features.map((feature, index) => {
                    const content = (
                        ...
                        >
                            ...
                            <div
                                className="relative z-10 mb-8 flex h-16 w-16 items-center justify-center rounded-2xl border border-zinc-100 bg-white shadow-[0_4px_20px_-4px_rgba(0,0,0,0.05)] transition-transform duration-500 group-hover:scale-110 group-active:scale-110 dark:border-zinc-800 dark:bg-zinc-950"
                            >
                    ...
                    if (feature.href) {
                        return (
                            <Link
                                ...
                                rel={feature.href.startsWith('http') ? 'noreferrer noopener' : undefined}
                            >
                                {content}
                            </Link>
                        );
