                        ...
                        <div className="relative">
                            ...
                            <div className="relative z-10 space-y-6 text-lg leading-relaxed text-foreground/80">
                                <p className="font-semibold text-foreground">
                                    ...
                                    kami mengucapkan selamat datang di website
                                    resmi{' '}
                                ...
                                <p>
                                    ...
                                    informasi, komunikasi, dan edukasi keislaman
                                    bagi seluruh jamaah serta masyarakat luas.
                                    Masjid ini tidak hanya berfungsi sebagai
                                    tempat ibadah, tetapi juga sebagai pusat
                                    dakwah, pembinaan umat, pendidikan
                                    Al-Qur'an, dan berbagai kegiatan sosial
                                    keagamaan lainnya.
                                </p>
                                <p>
                                    Melalui platform digital ini, kami ingin
                                    menghadirkan kemudahan bagi masyarakat untuk
                                    mengakses informasi seputar jadwal sholat,
                                    kegiatan masjid, kajian islami, layanan
                                    keagamaan, hingga dokumentasi
