                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div className="mb-16 text-center">
                        ...
                        <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
                            ...
                            fasilitas dan pelayanan Masjid Agung Al-Mukarram
                            demi kenyamanan beribadah bersama.
                        </p>
                    </div>
                            ...
                            <div className="group flex items-start gap-5 rounded-3xl bg-card p-6 shadow-sm ring-1 ring-border transition-all hover:-translate-y-1 hover:shadow-md hover:ring-primary/50">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted-foreground">
                                        Jl. Tambun Bungai No. 1, Selat Tengah,
                                        Kec. Selat, Kabupaten Kapuas, Kalimantan
                                        Tengah 73511
                                    </p>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <div className="mt-auto pt-4 lg:pt-0">
                                    ...
                                    <p className="mt-4 text-center text-xs text-muted-foreground">
                                        Laporan terkirim akan langsung
                                        diteruskan ke tim pengurus/layanan
                                        jamaah terkait.
                                    </p>
                                </div>
                            </form>
