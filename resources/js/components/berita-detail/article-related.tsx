            ...
            <div className="relative z-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {items.map((item) => (
                    <Link
                        ...
                        className="group flex flex-col overflow-hidden rounded-3xl border border-border bg-white transition-all duration-500 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/10 active:-translate-y-1 active:shadow-xl active:shadow-blue-500/10 dark:bg-zinc-900"
                    >
                        {/* Thumb */}
                        <div className="relative aspect-4/3 overflow-hidden bg-zinc-100 dark:bg-zinc-800">
                            ...
                            {/* Overlay gradient */}
                            <div className="absolute inset-0 bg-linear-to-t from-black/40 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-active:opacity-100" />
                            {/* Arrow on hover */}
                            <div className="absolute right-3 bottom-3 flex h-8 w-8 items-center justify-center rounded-full bg-white/90 opacity-0 shadow-md backdrop-blur-md transition-all duration-300 group-hover:opacity-100 group-active:opacity-100 dark:bg-zinc-900/90">
                        ...
                        <div className="flex flex-1 flex-col gap-2 p-4">
                            <h4 className="line-clamp-3 text-[13px] leading-snug font-bold text-foreground transition-colors group-hover:text-blue-600 group-active:text-blue-600">
                                {item.judul}
                            </h4>
