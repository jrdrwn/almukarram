                ...
                <div className="grid items-center gap-12 lg:grid-cols-12 lg:gap-8">
                    <div className="lg:col-span-5">
                        <div className="relative flex h-80 items-center justify-center rounded-3xl bg-linear-to-br from-[#e8f5ee] to-[#c8e6d0] shadow-sm">
                            <MoonStar className="h-32 w-32 text-primary opacity-35" />
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-7">
                        ...
                        <p className="mb-4 text-lg leading-relaxed text-muted-foreground">
                            <strong className="text-foreground">Imarah</strong>{' '}
                            adalah bidang yang bertanggung jawab atas kemakmuran
                            dan keramaian masjid, meliputi penyelenggaraan
                            ibadah, dakwah, pendidikan Al-Qur'an, kajian Islam,
                            serta berbagai kegiatan keagamaan dan sosial
                            kemasyarakatan.
                        </p>
                        <p className="mb-8 text-lg leading-relaxed text-muted-foreground">
                            Bidang ini menjadi motor penggerak utama dalam
                            menjadikan masjid sebagai pusat peradaban Islam yang
                            dinamis dan memberi manfaat nyata bagi masyarakat
                            Kabupaten Kapuas.
                        </p>
