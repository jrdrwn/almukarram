...
export default function HeroSection({
    ...
    return (
        <div className="relative overflow-hidden rounded-[2.5rem] bg-[#0A2617] px-4 py-10 shadow-[0_20px_50px_-12px_rgba(10,38,23,0.6)] sm:px-12 sm:py-16">
            ...
            <div className="absolute -left-[20%] top-0 z-0 h-150 w-150 -translate-y-1/2 rounded-full bg-emerald-500 opacity-20 blur-[130px] mix-blend-screen"></div>
            <div className="absolute -bottom-[20%] -right-[10%] z-0 h-125 w-125 rounded-full bg-[#fce883] opacity-10 blur-[120px] mix-blend-screen"></div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <div className="mt-4 flex w-full max-w-4xl flex-col items-center justify-center gap-8 md:flex-row md:justify-around lg:gap-16">
                    <div className="flex flex-col items-center">
                        <div className="mb-2 text-[0.75rem] font-bold uppercase tracking-[0.25em] text-emerald-400/80">
                            Waktu Sekarang
                        </div>
                    ...
                    <div className="flex flex-col items-center rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-md md:border-none md:bg-transparent md:p-0 md:backdrop-blur-none">
                        <div className="next-prayer-label mb-2 text-[0.75rem] font-bold uppercase tracking-[0.25em] text-emerald-400/80">
                            Menyiapkan Data...
                        </div>
                ...
                <div className="mt-14 flex w-full flex-nowrap gap-3 overflow-x-auto pb-6 pt-2 snap-x snap-mandatory scrollbar-hide sm:justify-center lg:grid lg:grid-cols-8 lg:overflow-visible lg:pb-0 lg:pt-0">
                    {waktuList.map(({ key, icon, label }) => (
                        ...
                        >
                            ...
                            <div className="mb-1.5 text-[0.65rem] font-bold uppercase tracking-widest text-emerald-100/70 sm:tracking-[0.2em]">
                                {label}
                            </div>
                            <div className="font-mono text-lg font-bold text-white sm:text-xl relative z-10">
                                {jadwal[key] || "—"}
                            </div>
                            <span
                                id={`aktif-${key}`}
                                className="label-aktif absolute -bottom-3 left-1/2 hidden -translate-x-1/2 whitespace-nowrap rounded bg-linear-to-r from-[#fce883] to-[#e8c63f] px-2 py-0.5 text-[0.6rem] font-black uppercase tracking-wider text-green-950 shadow-md"
                            >
                                SEKARANG
                            </span>
                        </div>
