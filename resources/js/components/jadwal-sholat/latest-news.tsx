    ...
    const displayBerita = berita.length > 0 ? berita : [
        {
            ...
            date: "12 Oct 2023",
            excerpt: "Hadirilah pengajian rutin kitab Riyadhus Shalihin bersama Ust. H. Ahmad.",
        ...
        },
        {
            ...
            date: "10 Oct 2023",
            excerpt: "Berikut adalah daftar petugas sholat jumat untuk bulan ini di Masjid Al-Mukarram.",
        ...
        },
        {
            ...
            date: "05 Oct 2023",
            excerpt: "Masjid Al-Mukarram membuka kesempatan amal jariyah untuk perluasan bangunan.",
            image: "https://images.unsplash.com/photo-1574246604907-db69e30fdcab?auto=format&fit=crop&q=80&w=400"
        }
    ];

    return (
        <div className="group relative overflow-hidden rounded-4xl border border-gray-100 bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:p-8 transition-all hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            ...
            <div className="relative z-10 mb-8 flex flex-col items-start gap-4 pb-4 border-b border-gray-100 sm:flex-row sm:items-center sm:justify-between">
                ...
                <Link
                    href="#"
                    className="flex items-center gap-1.5 text-sm font-bold text-orange-600 hover:text-orange-700 transition-colors bg-orange-50/50 px-4 py-2 rounded-xl ring-1 ring-orange-100"
                >
                    Lihat Semua
            ...
            <div className="relative z-10 grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
                {displayBerita.map((item) => (
                    <div key={item.id} className="group/news flex flex-col overflow-hidden rounded-3xl bg-white ring-1 ring-gray-100 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:ring-gray-200">
                        <div className="relative aspect-4/3 overflow-hidden">
                            <img
                                ...
                                onError={(e) => {
                                    e.currentTarget.src = "https://images.unsplash.com/photo-1584551246679-0daf3d275d0f?auto=format&fit=crop&q=80&w=400";
                                }}
                            />
                            ...
                            <div className="absolute right-3 top-3 translate-x-4 opacity-0 transition-all duration-300 group-hover/news:translate-x-0 group-hover/news:opacity-100">
                        ...
                        <div className="flex flex-1 flex-col p-5">
                            ...
                            <h4 className="mb-2 text-lg font-bold leading-tight text-gray-900 group-hover/news:text-orange-600 transition-colors line-clamp-2">
                                {item.title}
                            </h4>
                            ...
                            <Link href="#" className="mt-auto inline-flex items-center text-sm font-bold text-gray-900 group-hover/news:text-orange-600">
                                Baca selengkapnya
