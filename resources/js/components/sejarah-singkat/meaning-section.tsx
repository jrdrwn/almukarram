                ...
                <div className="grid grid-cols-1 gap-8 md:gap-12 lg:grid-cols-2">
                    <div className="group relative h-full overflow-hidden rounded-[3rem] bg-linear-to-br from-zinc-100 to-zinc-200/50 p-1 shadow-lg shadow-primary/5 transition-transform duration-500 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10 dark:from-zinc-800 dark:to-zinc-900/50 dark:shadow-none">
                        <div className="relative h-full overflow-hidden rounded-[2.8rem] bg-card p-8 md:p-12">
                            <div className="pointer-events-none absolute -top-20 -right-20 z-0 h-64 w-64 rounded-full bg-primary/5 blur-[50px] transition-transform duration-700 group-hover:scale-150" />

                            <div className="relative z-10">
                                <div className="mb-8 flex items-center gap-6">
                                    <div className="flex h-16 w-16 shrink-0 transform items-center justify-center rounded-3xl bg-linear-to-br from-primary to-primary/80 shadow-lg shadow-primary/20 transition-transform duration-500 group-hover:rotate-12">
