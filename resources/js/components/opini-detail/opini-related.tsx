            ...
            <div className="relative z-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
                {items.map((item, idx) => (
                    <Link
                        ...
                        className="group flex flex-col justify-between overflow-hidden rounded-3xl border border-border bg-white p-5 transition-all duration-500 hover:-translate-y-1 hover:shadow-xl hover:shadow-violet-500/10 dark:bg-zinc-900"
                    >
                        {/* Grid texture bg */}
                        <div className="absolute inset-0 z-0 rounded-3xl bg-[linear-gradient(to_right,#80808008_1px,transparent_1px),linear-gradient(to_bottom,#80808008_1px,transparent_1px)] bg-size-[20px_20px] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                        ...
                        <div className="relative z-10">
                            ...
                            <h4 className="mb-3 line-clamp-3 text-sm leading-snug font-bold text-foreground transition-colors group-hover:text-violet-600">
                                {item.title}
                            </h4>
                        ...
                        <div className="relative z-10 mt-4 flex items-center justify-between border-t border-border/60 pt-3">
                            ...
                            <div className="flex h-7 w-7 items-center justify-center rounded-full bg-white opacity-0 shadow-sm ring-1 ring-border transition-all duration-300 group-hover:opacity-100 dark:bg-zinc-900">
