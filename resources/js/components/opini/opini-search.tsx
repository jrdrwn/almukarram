...
export default function OpiniSearch({ searchQuery = '', kategoriSlug = 'semua', totalRows = 0, kategoris = [] }: OpiniSearchProps) {
    ...
    // Parse valid date for initial state
    ...
    const submitSearch = (payload: any) => {
        ...
        router.get('/opini', params as any, { preserveState: true, preserveScroll: true });
    };
