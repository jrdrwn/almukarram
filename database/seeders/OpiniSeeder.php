...
class OpiniSeeder extends Seeder
{
    ...
    {
        $kategoris = Kategori::where('type', 'opini')->pluck('id', 'slug');

        $items = [
            [
                'judul'       => 'Masjid sebagai Pusat Peradaban: Meneladani Masjid Nabawi',
                'kategori_id' => $kategoris['dakwah'] ?? null,
            ...
            [
                ...
                'kategori_id' => $kategoris['keluarga'] ?? null,
            ...
            [
                ...
                'kategori_id' => $kategoris['sosial-opini'] ?? null,
